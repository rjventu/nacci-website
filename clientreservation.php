                        ...
                        <?php
                                while ($row = $result->fetch_assoc()) 
                                {
                                    ...
                                    if($row['status'] == "CANCELLED"){
                                        ...
                                        echo '<a href="clientreservation_edit.php?id='.$id.'"><button type="button" class="btn btn-primary me-2">
                                        Edit</button></a>';
                                        echo '<a href="#" onclick="myFunction('.$id.')"><button type="button" class="btn btn-danger">
                                        Cancel</button></a>';
                                    }
                                    echo '</td>';
                                    echo '</tr>';
